  ...
  [2],
  {
    ...
    IKlv: function(e, t, r) {
      ...
      (t.__esModule = !0),
        (t.render = ee),
        (t.renderError = re),
        (t.default = t.emitter = t.ErrorComponent = t.router = t.dataManager = void 0);
      var f = l(r('+oT+')),
        d = l(r('htGi')),
        m = l(r('eVuF')),
        h = p(r('q1tI')),
      ...
      var N = M.props,
        ...
        A = M.query,
        D = M.buildId,
        H = (M.dynamicBuildId, M.assetPrefix),
        O = M.runtimeConfig,
        q = M.dynamicIds,
      ...
      t.dataManager = L;
      var B = H || '';
      (r.p = B + '/_next/'), k.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: O || {} });
      var X = (0, _.getURL)(),
        G = new y.default(D, B),
        j = function(e) {
          var t = s(e, 2),
            ...
            o(t, [
              ...
              },
              {
                ...
                value: function() {
                  this.scrollToHash(),
                    M.nextExport &&
                      ((0, T.isDynamicRoute)(K.pathname) || location.search || M.skeleton) &&
                      K.replace(
                        K.pathname +
                          '?' +
                          (0, C.stringify)(
                            (0, d.default)({}, K.query, (0, C.parse)(location.search.substr(1)))
                          ),
                        X,
                        { _h: 1 }
                      );
              ...
              function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      return (W = e.sent), (a = I), (e.prev = 6), (e.next = 9), G.loadPage(S);
                    case 9:
                      (V = e.sent), (e.next = 14);
                      break;
                    case 14:
                    ...
                    case 19:
                      ...
                      return (e.next = 22), window.__NEXT_PRELOADREADY(q);
                    case 22:
                      return (
                        (t.router = K = (0, E.createRouter)(S, A, X, {
                          initialProps: N,
                          pageLoader: G,
                          App: W,
                          Component: V,
                        ...
                        ee({ App: W, Component: V, props: N, err: a, emitter: $ }),
                        e.abrupt('return', $)
                      );
                    case 27:
                    case 'end':
            ...
            return n.wrap(function(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 6:
                    if (
                      ((t.ErrorComponent = z = e.sent),
                      (u = se(a)),
                      (i = {
                        Component: z,
                        AppTree: u,
                        router: K,
                        ctx: { err: o, pathname: S, query: A, asPath: X, AppTree: u }
                      }),
                      !r.props)
                    ) {
                      e.next = 13;
                    ...
                    break;
                  case 13:
                    return (e.next = 15), (0, _.loadGetInitialProps)(a, i);
                  case 15:
                    e.t0 = e.sent;
                  case 16:
                    return (
                      (c = e.t0),
                      (e.next = 19),
                      pe((0, d.default)({}, r, { err: o, Component: z, props: c }))
                    );
                  case 19:
                  case 'end':
                    return e.stop();
      ...
      function ce(e) {
        ...
        return h.default.createElement(
          ...
          h.default.createElement(
            h.Suspense,
            { fallback: h.default.createElement('div', null, 'Loading...') },
            h.default.createElement(
              b.RouterContext.Provider,
              { value: (0, E.makePublicRouterInstance)(K) },
              h.default.createElement(
                R.DataManagerContext.Provider,
                { value: L },
                h.default.createElement(w.HeadManagerContext.Provider, { value: J.updateHead }, t)
              )
            )
          )
        );
      ...
      var se = function(e) {
        return function(t) {
          var r = (0, d.default)({}, t, { Component: V, err: I, router: K });
          return h.default.createElement(ce, null, h.default.createElement(e, r));
        };
      };
      function pe(e) {
      ...
      function le() {
        return (le = (0, f.default)(
          n.mark(function e(t) {
            var r, a, o, u, i, c, s, p, l, f, m;
            return n.wrap(function(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    ...
                    return (
                      ...
                      (f = {
                        ...
                        AppTree: l,
                        Component: z,
                        ctx: { err: u, pathname: c, query: s, asPath: p, AppTree: l }
                      }),
                      (e.next = 7),
                      (0, _.loadGetInitialProps)(r, f)
                    );
                  case 7:
                    o = e.sent;
                  case 8:
                    (a = a || F.Component),
                      (o = o || F.props),
                      (m = (0, d.default)({}, o, { Component: a, err: u, router: K })),
                      (F = m),
                      ...
                      (n = h.default.createElement(ce, null, h.default.createElement(r, m))),
                      (g = Y),
                      _.SUPPORTS_PERFORMANCE_USER_TIMING && performance.mark('beforeRender'),
                      ae ? (v.default.hydrate(n, g, oe), (ae = !1)) : v.default.render(n, g, ue),
      ...
      var f = (function() {
        function e(t, r) {
          a(this, e),
            ...
            (this.loadingRoutes = {}),
            (this.promisedBuildId = c.default.resolve());
        }
        return (
          o(e, [
            {
